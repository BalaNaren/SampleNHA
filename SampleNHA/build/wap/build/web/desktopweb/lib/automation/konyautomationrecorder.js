(function() {
    ...
    var defaultReporter = {
        ...
        specDone: function(result) {
            var karConfig = _kony.automation.server, wSocket = null,
                reportMessage = null;
        ...
        jasmineDone: function(result) {
            ...
            if(_kony.automation.captureFailedTestSuites) {
                rerunSuites = {
    ...
    var runRegularAutomation = function(konyAutomationPath) {
        var $K = kony.$kwebfw$, appName = appConfig.appName;
        var testScriptPaths = {
            "testScripts": konyAutomationPath,
            "Test Suites": konyAutomationPath + "/" + appName + "/Test Suites",
            "Test Cases": konyAutomationPath + "/" + appName + "/Test Cases",
            "Test Plans": konyAutomationPath + "/" + appName + "/Test Plans"
        }
        ...
        if($K.behavior.isCompositeApp) {
            ...
            { 
                ...
                testScriptPaths[microAppName + "/Test Cases"] = konyAutomationPath + "/" + microAppName + "/Test Cases";
                testScriptPaths[microAppName + "/Test Suites"] = konyAutomationPath + "/" + microAppName + "/Test Suites";
                testScriptPaths[microAppName + "/Test Plans"] = konyAutomationPath + "/" + microAppName + "/Test Plans";
            }
        } else {
            testScriptPaths[appName + "/Test Cases"] = konyAutomationPath + "/" + appName + "/Test Cases";
            testScriptPaths[appName + "/Test Suites"] = konyAutomationPath + "/" + appName + "/Test Suites";
            testScriptPaths[appName + "/Test Plans"] = konyAutomationPath + "/" + appName + "/Test Plans";
        }
        requirejs.config({
                        ...
                        try {
                            if(metaInfoRequest.response && metaInfoRequest.response.length !== 0) {
                                ...
                                if(automationConfig.captureFailedTestSuites) {
                                    _kony.automation.captureFailedTestSuites = automationConfig.captureFailedTestSuites
                                }
                                if(enableRecording) {
