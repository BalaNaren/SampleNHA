...
(function() {
    ...
    ****************************************************************************/
    ...
    Object.defineProperty(kony.ui, 'addWidgetToEle', {configurable:false, enumerable:false, writable:false, value:(function() {
        var addWidgetToEle = function addWidgetToEle(model, renderTo) {
            var $K = kony.$kwebfw$, $KU = $K.utils, $KW = $K.widget, supportedWidget = false,
                flag = $KU.loadedFromOtherFramework(), _render = null, ele = null;

            supportedWidget = (model instanceof kony.ui.FlexContainer || model instanceof kony.ui.UserWidget);
            ...
            if (supportedWidget && flag) {
                ...
                if (renderTo) {
                    ele = document.getElementById(renderTo);
